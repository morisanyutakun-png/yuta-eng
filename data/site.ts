...
export const siteConfig = {
  ...
  description:
    "ノビットスタディ 中高部は、自作教材を好きなタイミングで1枚ずつ進める、買い切りのデジタル通信添削。提出した答案は著者本人が添削し、合格ラインに届くと次の教材が届きます。保護者も進捗を確認できます。教材×習慣化×添削。物理・化学・数学・英語、1教材（約100日分・添削込み）買い切り¥14,800〜、8/6まで開講記念パック割、入会金・追加費用0円。",
  url: siteUrl,
  author: "森 祐太",
  email: contactEmail,
  locale: "ja_JP",
