...
export const apps: AppItem[] = [
  {
    ...
    description:
      "物理の森は、Solvora が運営する高校物理専門のオンライン塾です。公式暗記ではなく、現象 → 図 → 式 の順で読み解く力を、個別カリキュラムで育てます。物理基礎・物理の通年指導、定期テスト対策、共通テスト・国公立二次・私大入試まで対応。受講相談は専門塾サイトから。",
  ...
  },
  {
    ...
    description:
      "Eddivom は、生成AIで作った下書きを LaTeX に流し込み、小テスト・類題・解答PDFまでをワンストップで出力できる教材作成Webアプリです。Solvora が公式に紹介しています。",
