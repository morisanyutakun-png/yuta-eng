...
export const apps: AppItem[] = [
  {
    ...
    comparison: "理系個別指導 オンライン｜AI 復習プリント付きで「理解で解く」個別指導。",
    description:
      "Solvora Learning Lab（旧『物理の森』）は、Solvora が運営する理系個別指導オンラインです。物理を出発点に、AI 復習プリント付きの理系個別指導へとブランドを拡張しました。公式暗記ではなく、現象 → 図 → 式の順で読み解く力を、生徒一人ひとりに合わせた個別カリキュラムで育てます。物理基礎・物理の通年指導、定期テスト対策、共通テスト・国公立二次・私大入試まで、理系科目に強い個別指導オンラインとして全国どこからでも受講可能です。",
    audience:
      "高校物理・数学でつまずいている高校1〜3年生・浪人生／理系科目を理解で解けるようになりたい受験生／オンラインの理系個別指導を探している保護者",
    category: "理系個別指導 オンライン",
    href: "https://physics.yuta-eng.com",
    ctaLabel: "Solvora Learning Lab を開く",
    status: "Solvora 直営",
    featured: true,
    primaryKeyword: "理系個別指導 オンライン",
    secondaryKeywords: [
    ...
    highlights: [
      {
        title: "AI 復習プリント付きの理系個別指導",
        body: "授業ごとに AI が当日の理解度に合わせた復習プリントを自動生成。指導 1 回 → 復習 1 セットがセットになり、独学側でも『どこを直すか』が明確になります。",
      },
      {
      ...
      {
        title: "「現象 → 図 → 式」の指導法",
        body: "Solvora ブログでも公開している『公式暗記から理解で解く』設計を、対話伴走型でカリキュラムに落とし込み。物理を中心に、関連する数学・情報の単元横断にも対応します。",
      },
    ],
    faq: [
      {
        question: "Solvora Learning Lab はどんな高校生に向いていますか？",
        answer:
          "高校物理・数学で公式暗記に頼ってきて応用問題で詰まる高校生・浪人生、共通テストや二次試験で安定して得点したい受験生に向いています。物理基礎からの再構築にも対応します（旧『物理の森』からのリブランド）。",
      },
      {
        question: "オンラインの理系個別指導は集団塾と何が違いますか？",
        answer:
          "Solvora Learning Lab は完全オンライン × 個別カリキュラムなので、生徒ごとに『どの単元から戻すか』『どこまで先取りするか』を1対1で設計できます。集団塾の進度に合わない生徒や、苦手単元だけを集中強化したい生徒に向いています。",
      },
      {
        question: "受講相談は無料ですか？",
        answer:
          "受講相談は無料です。受講前提でなくても構いません。現状の偏差値・志望校・残り時間を伺い、最初の3ヶ月の学習プラン案を提示します。",
      },
    ],
  },
  {
