...
export const apps: AppItem[] = [
  ...
  },
  {
    ...
    description:
      "Physics は、Solvora が提供する高校物理アプリです。力学・電磁気・波動・熱・原子の各単元を、概念解説 → 例題 → 演習の 3 ステップでスマホから学べます。公式暗記ではなく『現象 → 図 → 式』の順で理解を積み上げる学習設計を、高校物理アプリとして使いやすい形に落とし込みました。通学・スキマ時間の演習から定期テスト前の総復習まで、高校物理を理解ベースで攻略したい受験生のための学習アプリです。",
    audience:
      "高校物理を独学・予習・復習したい高校1〜3年生／スマホで物理の概念と演習を回したい受験生／物理が苦手で短時間学習を積み上げたい人",
    category: "高校物理 アプリ",
    href: "https://physics.yuta-eng.com",
    ctaLabel: "Physics（高校物理 アプリ）を開く",
    status: "Solvora 提携",
