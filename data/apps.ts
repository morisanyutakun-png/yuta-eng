...
export const apps: AppItem[] = [
  ...
  },
  {
    ...
    description:
      "Physics は、Solvora が提供する高校物理アプリです（個別指導サービスの『物理の森』とは別の自学アプリです）。力学・電磁気・波動・熱・原子の各単元を、概念解説 → 例題 → 演習の 3 ステップでスマホから学べます。公式暗記ではなく『現象 → 図 → 式』の順で理解を積み上げる学習設計を、高校物理アプリとして使いやすい形に落とし込みました。通学・スキマ時間の演習から定期テスト前の総復習まで、高校物理を理解ベースで攻略したい受験生のための学習アプリです。",
    audience:
      "高校物理を独学・予習・復習したい高校1〜3年生／スマホで物理の概念と演習を回したい受験生／物理が苦手で短時間学習を積み上げたい人",
    category: "高校物理 アプリ",
    href: "https://physics.yuta-eng.com",
    ctaLabel: "Physics（高校物理アプリ）を開く",
    status: "Solvora 提携",
    ...
    schemaAudience: "student",
    alternateName: ["Physics 高校物理アプリ", "高校物理アプリ Physics"],
    highlights: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Solvora が運営する Physics は、高校物理アプリの中でも『公式暗記ではなく理解で解く』ことに特化した学習設計です。単元別の概念解説 → 例題 → 演習の 3 ステップで、スマホから短時間で物理の力をつけられます。",
      },
      {
        question: "Physics と『物理の森』はどう違いますか？",
        answer:
          "Physics は自学用の高校物理アプリ（スマホで概念解説 → 例題 → 演習を回す）、物理の森は講師による個別指導のオンライン専門塾です。前者は独学の積み上げ、後者は1対1のカリキュラム設計に向いています。両方を組み合わせて使うことも可能です。",
      },
      {
        question: "Physics は独学でも使えますか？",
        answer:
          "Physics は独学を前提に設計されています。各単元に概念解説と段階的な例題が入っているので、教科書を持っていなくても学習できます。さらに深く学びたい人は、姉妹サービス『物理の森（物理専門塾オンライン）』で個別指導も受けられます。",
      },
      {
