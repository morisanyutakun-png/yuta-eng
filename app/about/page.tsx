...
const principles = [
  ...
  },
  {
    ...
    text: "面談や授業はしません。自分のペースで演習を進め、提出した答案を添削で軌道修正する。生活に合わせて続けられる、自立学習の形を設計しています。",
  },
];
...
const expertise = [
  ...
  },
  {
    label: "Tech",
    title: "学習管理システム",
    body: "応用情報技術者として培った技術で、演習・提出・添削が回る独自の学習管理を設計・運用しています。",
  },
];
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-7 grid gap-5 text-[1rem] leading-[2.05] text-[#334155] sm:text-[1.04rem]">
              ...
              <p>
                ...
                面談や授業（ライブ指導）は行いません。代わりに、自分のペースで教材を進め、
                提出した答案に添削が入る。塾長が設計した教材と提出ごとの添削で、
                <strong className="font-bold text-[#0b1d4a]">自立した学び</strong>を実現します。
              </p>
              <p>
                目指すのは、塾としては手の届きやすい料金で、提出ごとに添削が受けられる環境です。
