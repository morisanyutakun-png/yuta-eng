...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  return (
    <Container>
      ...
      />
      <article className="mx-auto max-w-4xl py-12 sm:py-16 lg:py-20">
        <Link
          className="inline-flex min-h-11 items-center text-sm font-semibold text-sky-800 transition hover:text-slate-950"
          href="/blog"
        >
          ← Blog一覧へ戻る
        </Link>
        <header className="mt-8 overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_28px_100px_-80px_rgba(15,23,42,0.75)] sm:rounded-[2.75rem]">
          <div className="bg-[radial-gradient(circle_at_20%_20%,rgba(56,189,248,0.3),transparent_34%),linear-gradient(145deg,#0f172a,#111827_58%,#082f49)] p-6 text-white sm:p-10">
            ...
            <h1 className="text-balance mt-5 font-serif text-3xl font-semibold leading-tight tracking-[-0.07em] sm:mt-6 sm:text-5xl lg:text-6xl">
              {post.title}
            </h1>
            <p className="text-pretty mt-5 text-base leading-8 text-slate-300 sm:mt-6 sm:text-lg sm:leading-9">
              {post.description}
            </p>
          </div>
      ...
      <section className="mx-auto max-w-4xl border-t border-slate-200 py-10 sm:py-12">
        <div className="rounded-[1.7rem] border border-slate-200 bg-white p-5 sm:rounded-[2rem] sm:p-7">
