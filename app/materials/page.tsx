...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "ノビットスタディの教材を詳しく紹介。提出・解答解説・添削の土台となるノビット公式教材（数学ⅠA・ⅡBC・ⅢC、化学基礎、化学標準、英語長文、英文法）と、開発者が制作する『考える力を育てる』シリーズ全16冊。理解で解く設計思想と、実際の演習本ページも掲載しています。",
  keywords: ["ノビット公式教材", "考える力を育てる 森祐太", "高校物理 教材", "数学 標準演習 問題集", "化学基礎", "化学 標準", "英語長文", "英文法"],
  path: "/materials",
});
        ...
        <Container className="px-6 py-16 sm:py-24">
          ...
          <div className="mx-auto mt-14 max-w-3xl">
            ...
            <p className="mt-3 text-center text-[0.78rem] leading-[1.7] text-[#64748b]">
              数値違いの並行類題＋方針つきの丁寧な解答解説。提出と自己採点に合わせて演習します。
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container className="relative px-6 py-20 sm:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-[0.95rem] leading-[1.95] text-white/80">
              ノビットのために書き下ろした公式教材。数学（ⅠA・ⅡBC・ⅢC）に加えて、化学基礎・化学標準・英語長文・英文法も、添削に合わせて使える形でそろえています。
            </p>
          </div>
        ...
        <Container className="px-6 py-16 sm:py-24">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-[0.96rem] leading-[1.95] text-[#475569]">
              教材は提出・解答解説・添削とセットで力に変わります。ノビットでの使い方はこうです。
            </p>
          </div>
          <ol className="mx-auto mt-10 grid max-w-4xl gap-5 sm:grid-cols-2">
            {[
              { n: "01", t: "今日の範囲に取り組む", b: "教材から取り組みやすく切り出された課題を、途中式・考え方まで書いて解きます。" },
        ...
        <Container className="px-6 py-16 sm:py-24">
          ...
          <div className="mx-auto mt-16 max-w-3xl">
            ...
            <ul className="mt-8 grid gap-3">
              {[
                { q: "教材は別で買う必要がありますか？", a: "いいえ。演習に使うノビット公式教材はサービスに含まれ、教材費は0円です。学習は公式教材を中心に進めます（市販書籍は、さらに演習したい方向けの任意の選択肢です）。" },
                { q: "どの科目の公式教材がありますか？", a: "数学（ⅠA・ⅡBC・ⅢC）の標準演習に加えて、化学基礎、化学標準、英語長文、英文法を公開しています。物理（基礎・標準・発展）も、サービス内の演習として順次整えていきます。" },
          ...
          <div className="mx-auto mt-14 max-w-3xl">
            <PageCtaRow title="今日の範囲が、いちばんの近道。" note="教材はサービスとセット。買い足しは不要で、提出ごとの添削で仕上げます。" />
          </div>
        </Container>
      </section>
    </>
