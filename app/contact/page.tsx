...
const contactFaq = [
  ...
  },
  {
    question: "料金と対応教材は？",
    answer:
      "料金は教材（講座）ごとの買い切りです。1教材 ¥14,800（約100日分の課題＋毎日添削込み）。2教材以上は開講記念パック割で1教材あたり ¥12,400（例：2教材 ¥24,800、8/6まで）。対応教材は物理 基礎・物理 標準・物理 発展・化学基礎・化学・数学IA・IIBC・IIIC・英語長文・英文法です。",
  },
  {
